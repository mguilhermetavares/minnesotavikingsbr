...
export default async function ArticlePage({
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 lg:pt-32 pb-16">
      ...
      {article.body && (
        <div className="mt-10 prose prose-invert prose-lg max-w-none prose-headings:text-white prose-p:text-white/80 prose-strong:text-white prose-a:text-vikings-gold">
